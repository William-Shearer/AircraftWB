...
#### Video Demo:  [Introduction Video](https://youtu.be/bo4MkWJnQD0)
...
This program was created exclusively for the **HarvardX CS50** course. The author was relatively familiar already with some programming languages, for example C, Lua, and HTML/CSS/JavaScript. However, Python 3 proved to be an unpleasant surprise, and made very little sense on first contact. It bore absolutely no similarity to anything the author had ever seen before, and appeared to have a philosophy that was at odds with everything that had previously constituted good programming habits.
...
- Multiple argument return from functions and unpacking (tuples)
- List comprehensions
- Lambda
